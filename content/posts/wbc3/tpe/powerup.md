...
{{< card-powerup code="PMNS" name="Engineering" description="25% faster building & new structures get +15% hp" cost="Unknown" hkey="">}}{{< /card-powerup >}}
...
{{< card-powerup code="PNCC" name="Ferocious Instinct" description="Units you control receive a bonus amount of XP based on how many hit points they are missing" cost="Unknown" hkey="">}}Orc (Graww)  Plaguelords (Gol-Draaka){{< /card-powerup >}}
...
{{< card-powerup code="PPEE" name="Fountain of Life" description="Doubles regen rate of all troops & improves Elcor's Balm" cost="Unknown" hkey="">}}{{< /card-powerup >}}
...
{{< card-powerup code="PGBB" name="Gorge" description="Allows Fire Giants to devour animals, regaining health" cost="Unknown" hkey="">}}Orc (Dark Orcs of Toragnar)  Orc (Orcs of Darkmyr){{< /card-powerup >}}
...
{{< card-powerup code="PLO3" name="Lore (IV)" description="+1 XP level for newly produced units" cost="Unknown" hkey="">}}{{< /card-powerup >}}
{{< card-powerup code="PLO4" name="Lore (V)" description="+1 XP level for newly produced units" cost="Unknown" hkey="">}}{{< /card-powerup >}}
...
{{< card-powerup code="PVMD" name="Mischievous Larceny" description="Allows Spriggans to use the Pilfer ability, which gives them a 100% chance to steal resources on their next attack" cost="Unknown" hkey="">}}{{< /card-powerup >}}
...
{{< card-powerup code="PMEL" name="Necromantic Reconstitution" description="The next building a zombie constructs costs less to construct depending upon the number of corpses they are holding" cost="Unknown" hkey="">}}{{< /card-powerup >}}
{{< card-powerup code="PGRG" name="Necrophagous Cannibalism" description="Allows units to devour corpses, regaining health" cost="Unknown" hkey="">}}Orc (Orcs of Darkmyr){{< /card-powerup >}}
...
{{< card-powerup code="PHNG" name="Pathogenic Acid" description="Allows Slimes to use the Fortitude Corrosion ability" cost="Unknown" hkey="">}}{{< /card-powerup >}}
{{< card-powerup code="PSBN" name="Phasing" description="Building blinking soul cost halved (but still needs a minimum of 1)" cost="Unknown" hkey="">}}Daemon (The Dark Path)  Daemon (The Iron Fortress){{< /card-powerup >}}
...
{{< card-powerup code="PPT2" name="Power of Couatl (I)" description="Gives your non-dragon elemental missile units +1 range and +5% damage" cost="Unknown" hkey="">}}Ssrathi (Night Ssrathi of Tzicolotl){{< /card-powerup >}}
...
{{< card-powerup code="POPN" name="Power of Tlatecolotl (I)" description="Gives a frostbite attack of strength 8 to melee units you control. If a melee unit already had a frostbite attack, instead, they gain +2 frostbite strength" cost="Unknown" hkey="">}}Orc (Goblin Mountain){{< /card-powerup >}}
{{< card-powerup code="PPT0" name="Power of Tlatecolotl (II)" description="Gives +5 frostbite strength to melee units you control, for a total of 11 frostbite strength. If a melee unit already had a frostbite attack, instead, they gain +2 frostbite strength, for a total of +4 frostbite strength" cost="Unknown" hkey="">}}Ssrathi (Night Ssrathi of Tzicolotl){{< /card-powerup >}}
...
{{< card-powerup code="PCOP" name="Reconstruct" description="Peasants gain +18 Mana and may use the Earthpower spell" cost="Unknown" hkey="">}}Dark Dwarf (The Verkanian Coalition){{< /card-powerup >}}
{{< card-powerup code="PBRV" name="Recruit Mercenaries" description="Recruits Mercenaries" cost="Unknown" hkey="">}}Minotaur (Order of the Broken Sword){{< /card-powerup >}}
...
{{< card-powerup code="PSPF" name="Relentless Ferocity" description="Allows Minotaur Scamps to use the Bleeding Charge ability" cost="Unknown" hkey="">}}{{< /card-powerup >}}
...
{{< card-powerup code="PHLW" name="Restoration (I)" description="Allows Unicorns to cast Cure which cures poisons, diseases, bleeding and crippling afflictions" cost="Unknown" hkey="">}}{{< /card-powerup >}}
{{< card-powerup code="PRT0" name="Restoration (II)" description="Allows Unicorns to cast Heal Group which restores lost HP to nearby friendly untis" cost="Unknown" hkey="">}}{{< /card-powerup >}}
...
{{< card-powerup code="PHDM" name="Revitalizing Command" description="Allows Imperial Sergeants to use the Encourage ability" cost="Unknown" hkey="">}}Daemon (The Dark Path){{< /card-powerup >}}
...
{{< card-powerup code="PMRT" name="Ride the Wind" description="Allows Warlords to use the Winds Grace ability" cost="Unknown" hkey="">}}Dwarf (Holy City of Duernoth)  Dwarf (Khamar, City of Artifice){{< /card-powerup >}}
...
{{< card-powerup code="PDMN" name="Rotten Earth" description="Mines you afflicted with Pestilence will give you +16.2% of their income (friendly and enemy mines included)" cost="Unknown" hkey="">}}Fey (Sacred Guard of Vivellius Madra){{< /card-powerup >}}
...
{{< card-powerup code="RCIE" name="Rune of Animos" description="Allows Dragon Knights to use Elemental Ward and Pegasi to use Hopeful Radiance" cost="Unknown" hkey="">}}Barbarian (Lindenloth)  Dark Elf (Archanon)  Dark Elf (Doomwood, The Dark Forest)  Dark Elf (Tierremar, Land of Eternal Grief)  Dark Elf (Yrm, Stronghold of Sorcery)  Wood Elf (Forest of Silvermyr)  Wood Elf (Light Elves of Twilight Woods)  Wood Elf (Sylvan Elves of Solhaven){{< /card-powerup >}}
{{< card-powerup code="PEOF" name="Rune of Cielos" description="Allows Iceguards to Iceshape, High Infantry to Deploy Defence Orbs and Longbows to Deploy Snares" cost="Unknown" hkey="">}}Orc (Orcs of Darkmyr){{< /card-powerup >}}
{{< card-powerup code="RANI" name="Rune of Manos" description="Allows Ice Maidens to use the Haste spell and Mystics to use the Watercall spell" cost="Unknown" hkey="">}}Dark Elf (Archanon)  Dark Elf (Doomwood, The Dark Forest)  Dark Elf (Tierremar, Land of Eternal Grief)  Dark Elf (Yrm, Stronghold of Sorcery)  Wood Elf (Forest of Silvermyr)  Wood Elf (Light Elves of Twilight Woods)  Wood Elf (Sylvan Elves of Solhaven){{< /card-powerup >}}
{{< card-powerup code="RMAN" name="Rune of Vivos" description="Allows Moonguards to use Disrupting Arrow ability and Manticores to use Dragonslayer Volley ability" cost="Unknown" hkey="">}}Dark Elf (Archanon)  Dark Elf (Doomwood, The Dark Forest)  Dark Elf (Tierremar, Land of Eternal Grief)  Dark Elf (Yrm, Stronghold of Sorcery)  Wood Elf (Forest of Silvermyr)  Wood Elf (Light Elves of Twilight Woods)  Wood Elf (Sylvan Elves of Solhaven){{< /card-powerup >}}
...
{{< card-powerup code="ROS0" name="Runes of Strife (II)" description="Gives +8% damage and a frenzy attack of strength 12 to melee units you control" cost="Unknown" hkey="">}}Minotaur (Order of Malignus){{< /card-powerup >}}
...
{{< card-powerup code="PSPT" name="Sanctity" description="Sacrifices generate Faith equal to 75% of their total resource cost (instead of 50%)" cost="Unknown" hkey="">}}Ssrathi (Night Ssrathi of Tzicolotl)  Ssrathi (Tongu, the Blessed Haven){{< /card-powerup >}}
{{< card-powerup code="PSNC" name="Sanctity" description="Sacrifices generate Faith equal to 75% of their total resource cost (instead of 50%)" cost="Unknown" hkey="">}}Ssrathi (Tongu, the Blessed Haven){{< /card-powerup >}}
{{< card-powerup code="PSAE" name="Sartek's Aegis" description="The Enrage ability also gives units +15% armor vs all damage types" cost="Unknown" hkey="">}}{{< /card-powerup >}}
...
{{< card-powerup code="PCNS" name="Self-Sufficiency (I)" description="Gives +2 ability levels to the Rally Vigilante ability" cost="Unknown" hkey="">}}{{< /card-powerup >}}
...
{{< card-powerup code="PNRC" name="Shadowy Embrace" description="Gives +4 resistance to all units you control during fog" cost="Unknown" hkey="">}}Undead (Gharedlun, Garden of the Dead){{< /card-powerup >}}
...
{{< card-powerup code="PSHS" name="Shattering Strength" description="Gives melee units you control +13% damage and a 7% chance to inflict the Break Armor critical effect" cost="Unknown" hkey="">}}{{< /card-powerup >}}
...
{{< card-powerup code="PSBG" name="Shielding Bough" description="All types of Treants emit light cover at a radius of 8." cost="Unknown" hkey="">}}{{< /card-powerup >}}
...
{{< card-powerup code="PSB0" name="Soul Absorption (II)" description="Allows Daemon units to absorb and generate twice as many souls" cost="Unknown" hkey="">}}Daemon (The Iron Fortress){{< /card-powerup >}}
{{< card-powerup code="PSB1" name="Soul Absorption (III)" description="Allows Daemon units to absorb and generate thrice as many souls" cost="Unknown" hkey="">}}Daemon (The Iron Fortress){{< /card-powerup >}}
{{< card-powerup code="PFAM" name="Soul Binding" description="Allows Quasits to use the Summon Planar Anchor ability" cost="Unknown" hkey="">}}Daemon (The Dark Path)  Daemon (The Iron Fortress){{< /card-powerup >}}
{{< card-powerup code="PDFW" name="Soul Elixir" description="Allows Doomspires to use the Cleanse ability which cures poisons & diseases" cost="Unknown" hkey="">}}{{< /card-powerup >}}
...
{{< card-powerup code="PBHR" name="Spatial Warp" description="Non-wall buildings you control gain a Confusion aura of range 12 and strength 9" cost="Unknown" hkey="">}}Minotaur (Order of Malignus){{< /card-powerup >}}
...
{{< card-powerup code="PMJV" name="Spear of Ank" description="+31.25% Damage for Tribesmen" cost="Unknown" hkey="">}}Barbarian (Hunters of Daros){{< /card-powerup >}}
{{< card-powerup code="PSPS" name="Spectral Shot" description="Garden Towers get an attack type which deals piercing-magic damage" cost="Unknown" hkey="">}}Undead (Gharedlun, Garden of the Dead){{< /card-powerup >}}
...
{{< card-powerup code="PEMN" name="Spiritualism" description="Allows Snakepriests to garrison in Altars of Couatl to generate Faith which can activate Blessings" cost="Unknown" hkey="">}}{{< /card-powerup >}}
{{< card-powerup code="PBSC" name="Spy Squad" description="This building gets +1 spy (max. 4) to use for infiltration" cost="Unknown" hkey="">}}Minotaur (Order of the Broken Sword){{< /card-powerup >}}
...
{{< card-powerup code="PUMB" name="Standardized Architecture" description="Buildings are 20% cheaper" cost="Unknown" hkey="">}}Empire (Diraqine Empire)  Minotaur (Raiders of the Pale Sea){{< /card-powerup >}}
...
{{< card-powerup code="PSTP" name="Steppe Lord" description="Warlords get a command radius of 4" cost="Unknown" hkey="Units in command radius gain +4 combat (+2 if undead) and +2 speed (+1 if undead)">}}Barbarian (Dragonslayers of Northern Reach){{< /card-powerup >}}
...
{{< card-powerup code="PFAV" name="Stonesense" description="Increases stone income by 37.5%" cost="Unknown" hkey="">}}Fey (Sacred Guard of Vivellius Madra){{< /card-powerup >}}
...
{{< card-powerup code="PSAK" name="Sundering Hex" description="Non-wall Dark Elf buildings you control gain a night storm and fear aura of strength 11, with a range of 12" cost="Unknown" hkey="">}}Dark Elf (Yrm, Stronghold of Sorcery){{< /card-powerup >}}
...
{{< card-powerup code="PPCH" name="Taming of the Stars" description="Allows Centaurs to use the Starfire Arrows ability" cost="Unknown" hkey="">}}Empire (Thalassian Empire){{< /card-powerup >}}
...
{{< card-powerup code="PHKJ" name="Trial by Glory" description="Allows Reavers to use the Bleeding Cleaves ability" cost="Unknown" hkey="">}}Barbarian (Alfheim, the Lost Valley)  Barbarian (Lindenloth){{< /card-powerup >}}
...
{{< card-powerup code="PDKC" name="Umbral Shroud" description="Allows to change day into night" cost="Unknown" hkey="">}}Plaguelords (Revenants of K'Oulis)  Undead (Gharedlun, Garden of the Dead){{< /card-powerup >}}
{{< card-powerup code="PFR2" name="Umbral Shroud" description="Allows to change day into night" cost="Unknown" hkey="">}}{{< /card-powerup >}}
{{< card-powerup code="PUHG" name="Unhallowed Grounds" description="Undead units can regenerate while garrisoned as if it was night" cost="Unknown" hkey="">}}Undead (Gharedlun, Garden of the Dead){{< /card-powerup >}}
...
{{< card-powerup code="PDRD" name="Unholy Ward" description="Gravestones gain an aura which gives Undead units +15% armor vs. all damage types and +2 resistance within a range of 12" cost="Unknown" hkey="">}}{{< /card-powerup >}}
{{< card-powerup code="PBLC" name="Unyielding Strike" description="Allows Pikemen to use the Bleeding Cleaves ability" cost="Unknown" hkey="">}}Barbarian (Alfheim, the Lost Valley)  Barbarian (Lindenloth)  Barbarian (Palmyr){{< /card-powerup >}}
...
{{< card-powerup code="PMBR" name="Vampire Bats" description="Giant Bats gain +2 vampirism" cost="Unknown" hkey="">}}Undead (Gharedlun, Garden of the Dead){{< /card-powerup >}}
...
{{< card-powerup code="PSTE" name="Vigorous Endurance" description="+2 Physical Resistance to all units" cost="Unknown" hkey="">}}{{< /card-powerup >}}
{{< card-powerup code="PSIO" name="Virus (I)" description="+100% Disease rate for all enemies within the Plague Pile's Disease aura" cost="Unknown" hkey="">}}{{< /card-powerup >}}
{{< card-powerup code="PVI0" name="Virus (II)" description="+200% Disease rate for all enemies within the Plague Pile's Disease aura" cost="Unknown" hkey="">}}Plaguelords (Gol-Draaka){{< /card-powerup >}}
{{< card-powerup code="PVI1" name="Virus (III)" description="+300% Disease rate for all enemies within the Plague Pile's Disease aura" cost="Unknown" hkey="">}}Plaguelords (Gol-Draaka){{< /card-powerup >}}
...
{{< card-powerup code="PCHC" name="Voice of Lurinth" description="Gives +2 speed to units you control and increases unit ability levels by +1" cost="Unknown" hkey="">}}{{< /card-powerup >}}
...
{{< card-powerup code="PLAL" name="Wolf Pack" description="Produces 5 Wolves" cost="Unknown" hkey="">}}{{< /card-powerup >}}
...
{{< card-powerup code="PRNC" name="Yacalli Arts" description="+2 to Assassination skill for Chameleons and Snakemen. Chameleons, Snakemen, Snakepriests and Nagas can traverse water" cost="Unknown" hkey="">}}Minotaur (Order of the Broken Sword){{< /card-powerup >}}
